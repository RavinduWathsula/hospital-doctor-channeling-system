...
import { LayoutDashboard, CalendarCheck, Clock, CalendarDays, Users, UserCircle, LogOut, Stethoscope } from 'lucide-react';
...
const DoctorLayout = () => {
    ...
    return (
        <div className="flex h-screen bg-gray-50 overflow-hidden font-sans">
            ...
            {/* Sidebar */}
            <aside className="w-64 bg-teal-900 text-white flex flex-col hidden md:flex shadow-xl z-20">
