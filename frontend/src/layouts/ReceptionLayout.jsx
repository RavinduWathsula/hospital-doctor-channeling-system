...
import { LayoutDashboard, Users, CalendarCheck, CheckSquare, Clock, LogOut, Building2 } from 'lucide-react';
...
const ReceptionLayout = () => {
    ...
    return (
        <div className="flex h-screen bg-gray-50 overflow-hidden font-sans">
            ...
            {/* Sidebar */}
            <aside className="w-64 bg-indigo-900 text-white flex flex-col hidden md:flex shadow-xl z-20">
