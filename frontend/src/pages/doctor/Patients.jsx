                    ...
                    {filteredPatients.length === 0 ? (
                        ...
                        filteredPatients.map((patient) => (
                            <div key={patient.id} className="bg-white rounded-3xl shadow-sm hover:shadow-2xl border border-slate-100 transition-all duration-300 group relative overflow-hidden flex flex-col p-6">
                                ...
                                <div className="absolute top-0 right-0 w-32 h-32 bg-theme-400 rounded-full mix-blend-multiply filter blur-3xl opacity-10 -mr-10 -mt-10 transition-all group-hover:scale-150 group-hover:opacity-20"></div>
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="mt-auto flex gap-3 border-t border-slate-100 pt-5">
                                        <button className="flex-1 flex items-center justify-center px-4 py-2.5 bg-theme-50 text-theme-700 font-bold rounded-xl hover:bg-theme-600 hover:text-white transition-colors group/btn">
